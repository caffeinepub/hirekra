...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      className: `fixed top-0 left-0 right-0 z-50 bg-white transition-shadow duration-300 ${scrolled ? "shadow-nav" : ""}`,
      children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-navy", children: [
                  "Hire",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue", children: "Kra" })
                ] })
              ]
            }
          ),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-white border-t border-border shadow-nav", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 flex flex-col gap-2", children: [
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, #0A2E45 0%, #0B3D5C 40%, #1E4D7A 70%, #1E6FA8 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 right-0 w-96 h-96 rounded-full opacity-10 bg-brand-blue blur-3xl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 left-0 w-80 h-80 rounded-full opacity-10 bg-white blur-3xl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center pt-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: "with HireKra"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-10 font-medium", children: "Your specialist recruitment partner across India & the Middle East — delivering the right talent, at the right time, every time." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3 mb-12", children: [
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 14 }), label: "Specialized Non-IT Hiring" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 14 }), label: "Volume Hiring" },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 14 }),
              label: "Contract & Permanent Staffing"
            },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 14 }), label: "Niche Hiring" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 14 }), label: "Customized to Your Goals" }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 flex flex-col items-center gap-2 text-white/40 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-10 bg-white/20" }),
...
function About() {
  const ref = useFadeIn();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "Who We Are",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed text-base", children: "HireKra is a fast-growing talent acquisition firm helping businesses scale with the right talent across India and the Middle East." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed text-base mt-4", children: "We specialize in Non-IT Contract And Permanent Staffing, Niche Hiring and bulk hiring solutions with speed and precision." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-2xl p-8 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-navy/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 22, className: "text-navy" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg text-foreground mb-2", children: "Our Mission" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "To deliver quality talent with speed and precision — enabling businesses to build high-performing teams that drive sustainable growth." })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-2xl p-8 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-brand-blue/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 22, className: "text-brand-blue" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg text-foreground mb-2", children: "Our Vision" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "To become a trusted global hiring partner — renowned for integrity, innovation, and the ability to match the right talent with the right opportunity." })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 max-w-sm mx-auto", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-extrabold mb-1", children: s.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/70 text-sm", children: s.label })
        ]
      },
      s.label
    )) })
...
function Presence() {
  const ref = useFadeIn();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "presence", className: "py-20 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "Our Reach",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border shadow-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "h-2",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground", children: "India" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Pan-India Hiring Capabilities" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 leading-relaxed", children: "Headquartered in Mumbai (Innov8 Parinee Crescenzo, Bandra East) with deep-rooted networks across all major metros and tier-2 cities. We source talent from every corner of the country." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border shadow-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "h-2",
            style: {
              background: "linear-gradient(90deg, #009736, #FFFFFF, #CE1126)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl", children: "🌍" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground", children: "Middle East" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "UAE, KSA, Qatar & Beyond" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 leading-relaxed", children: "Expanding presence in the Middle East, connecting Indian talent with opportunities in the region's fastest-growing economies." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: [
            "Dubai",
            "Abu Dhabi",
            "Riyadh",
...
function Expertise() {
  ...
  const industries = [
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 16 }), label: "Technology" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 16 }), label: "BFSI" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 16 }), label: "Healthcare" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 16 }), label: "E-commerce" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 16 }), label: "Startups" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "expertise", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "What We Do",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-2 gap-5 mb-12", children: services.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-navy/10 group-hover:bg-navy group-hover:text-white flex items-center justify-center text-navy mb-5 transition-all duration-300", children: s.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-base text-foreground mb-2", children: s.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: s.desc })
        ]
      },
      s.title
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-navy rounded-2xl p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm font-medium text-center mb-5 uppercase tracking-wider", children: "Industries We Serve" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3", children: industries.map((ind) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
...
function HiringProcess() {
  ...
  const steps = [
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 22 })
    },
    {
      number: "02",
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 22 })
    },
    {
      number: "04",
      title: "Interview Coordination",
      desc: "Seamless scheduling and coordination of interviews between candidates and your hiring team.",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 22 })
    },
    {
      number: "05",
      title: "Offer & Closure",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "process", className: "py-20 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "How We Work",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(90deg, #1E6FA8 0%, #60C3F5 100%)",
            zIndex: 0
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-5 gap-4 relative z-10", children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: i === 0 ? "linear-gradient(135deg, #0A2E45, #1E6FA8)" : "white",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-sm text-foreground mb-2 leading-snug", children: step.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden flex flex-col gap-4", children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-sm text-foreground mb-1", children: step.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed", children: step.desc })
          ] })
        ]
      },
...
function Leadership() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "leadership", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "Our Team",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-8 max-w-3xl mx-auto", children: leaders.map((l, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg text-foreground", children: l.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue text-sm font-semibold", children: l.role })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: l.bio })
          ] })
        ]
      },
      l.name
...
function WhyChoose() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "Why HireKra",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-2 gap-5", children: reasons.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex gap-4 bg-card border border-border rounded-2xl p-7 shadow-card",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-brand-blue/10 flex items-center justify-center text-brand-blue shrink-0 mt-0.5", children: r2.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-sm text-foreground mb-1.5", children: r2.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: r2.desc })
          ] })
        ]
      },
      r2.title
...
function ClientCTA() {
  ...
  const ctaActions = [
    {
      label: "Book a Call",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { size: 20 }),
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Handshake, { size: 20 }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-1/4 w-72 h-72 rounded-full opacity-10 bg-white blur-3xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-1/4 w-64 h-64 rounded-full opacity-10 bg-sky-300 blur-3xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 bg-white/15 border border-white/25 text-white/90 text-xs font-semibold rounded-full px-4 py-1.5 mb-6 uppercase tracking-wider", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 12 }),
            "Work With HireKra"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-extrabold text-white leading-tight mb-4", children: [
            "Ready to Build Your",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-lg max-w-xl mx-auto mb-12 leading-relaxed", children: "Take the next step — choose how you'd like to work with us and let's start building something great together." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: ctaActions.map((action) => {
            ...
            if (action.variant === "hire") {
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, rgba(30,79,122,0.8) 0%, rgba(30,111,168,0.9) 100%)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-10 text-white/45 text-sm", children: "No commitment required · Typically respond within 24 hours" })
        ] }) })
      ]
    }
  );
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "Get in Touch",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl shadow-card p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg text-foreground mb-6", children: "Send Us a Message" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                ...
                onChange: (e) => setForm((p) => ({ ...p, hiringNeeds: e.target.value })),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: submitting ? "Sending..." : "Let's Build Your Team"
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-navy rounded-2xl p-8 text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-6", children: "Reach Us Directly" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-white/15 flex items-center justify-center group-hover:bg-white/25 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 18 }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs", children: "Email" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "info@hirekra.com" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                className: "flex items-center gap-4 group",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-white/15 flex items-center justify-center group-hover:bg-white/25 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 18 }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs", children: "Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "+91 85870 79103" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-white/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 18 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs", children: "Headquarters" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold text-sm leading-snug", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { size: 22 }),
              "Connect on LinkedIn"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-7 shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm text-foreground mb-3", children: "Response Time" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed", children: [
            "We typically respond within",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-navy", children: "24 hours" }),
            ". For urgent hiring needs, please mention it in your message and we'll prioritize your request."
          ] })
        ] })
      ] })
    ] })
...
function Footer() {
  ...
  const scrollTo = (href) => {
    var _a2;
    return (_a2 = document.querySelector(href)) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm leading-relaxed max-w-xs", children: "Your trusted recruitment partner across India & the Middle East. Building teams that drive growth." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm uppercase tracking-wider text-white/80 mb-4", children: "Quick Links" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
              ...
              ["Contact", "#contact"]
            ].map(([label, href]) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm uppercase tracking-wider text-white/80 mb-4", children: "Services" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
              "Non-IT & Bulk Hiring",
              "Startup Hiring",
              "Leadership Hiring",
              "Contract Staffing"
            ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-white/60 text-sm", children: s }, s)) })
          ] })
        ] }),
...
function SectionHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-extrabold text-foreground mb-4", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base max-w-xl mx-auto leading-relaxed", children: subtitle })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(HiringProcess, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Leadership, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WhyChoose, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ClientCTA, {}),
