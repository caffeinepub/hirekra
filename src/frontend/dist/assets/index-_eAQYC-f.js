        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-9 h-9 rounded-lg bg-navy text-white text-sm font-extrabold tracking-tight", children: "HK" }),
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center pt-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 14, className: "text-yellow-300 fill-yellow-300" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/90 text-sm font-medium", children: "Trusted by 50+ Companies across India & Middle East" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-10 font-medium", children: "Your trusted recruitment partner across India & the Middle East — connecting top talent with ambitious organizations." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3 mb-12", children: [
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 14 }), label: "Fast Hiring Turnaround" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 14 }), label: "Strong Talent Network" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 14 }), label: "Pan-India & Middle East" }
...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto text-center mb-14", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed text-base", children: "HireKra was founded with a singular mission — to bridge the gap between exceptional talent and forward-looking organizations. We bring speed, precision, and deep industry knowledge to every hiring engagement, enabling businesses to scale with confidence." }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border shadow-card overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 leading-relaxed", children: "Headquartered in India with deep-rooted networks across all major metros and tier-2 cities. We source talent from every corner of the country." }),
...
function Expertise() {
  ...
  const industries = [
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { size: 16 }), label: "Technology" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "expertise", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12", children: services.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `group bg-card border border-border rounded-2xl p-7 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300 ${i === 4 ? "sm:col-start-2 lg:col-start-auto" : ""}`,
        children: [
...
function Leadership() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "leadership", className: "py-20 bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        badge: "Our Team",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-navy/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 18, className: "text-navy" }) })
            ] }),
...
function WhyChoose() {
  ...
  const reasons = [
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 22 }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "section-fade-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: reasons.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `flex gap-4 bg-card border border-border rounded-2xl p-7 shadow-card ${i === 4 ? "sm:col-span-2 lg:col-span-1 lg:col-start-2" : ""}`,
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
              ...
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "contact@hirekra.com" })
                  ] })
                ]
              }
            ),
              ...
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "+91 XXXXX XXXXX" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "India" })
              ] })
            ] })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-10 h-10 rounded-lg bg-brand-blue text-white text-sm font-extrabold", children: "HK" }),
